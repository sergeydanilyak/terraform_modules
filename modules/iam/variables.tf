variable "cluster_name" { # set cluster name manual
  description = "Name of the EKS cluster. Also used as a prefix in names of related resources."
  type        = string
  default     = ""
}
variable "create_eks" { # create or not create !!!
  description = "Controls if EKS resources should be created (it affects almost all resources)"
  type        = bool
  default     = true
}
variable "cluster_iam_role_name" { # role names
...
variable "manage_cluster_iam_resources" { # enable create role
...
#
#
# variable "cluster_enabled_log_types" { # enables logs
#   description = "A list of the desired control plane logging to enable. For more information, see Amazon EKS Control Plane Logging documentation (https://docs.aws.amazon.com/eks/latest/userguide/control-plane-logs.html)"
#   type        = list(string)
#   default     = []
# }
#
# variable "cluster_version" { # set cluster version
